...
class IndividualReceiverOrderPage extends StatefulWidget {
  ...
  @override
  State<IndividualReceiverOrderPage> createState() => _IndividualReceiverOrderPageState();
}

class _IndividualReceiverOrderPageState extends State<IndividualReceiverOrderPage> {
                                ...
                                Text.rich(
                                  TextSpan(
                                    children: [
                                      ...
                                      TextSpan(
                                        text: "${donor!["doorNumber"]}, ${donor!["street"]}, ${donor!["area"]}, ${donor!["city"]} - ${donor!["pincode"]}",
                                      ),
                                    ],
                                  ),
                                ),
